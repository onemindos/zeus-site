...
// This page is a client component for form state — SEO handled by layout defaults.
...
const TYPES = ["course", "speaking", "consulting", "other"] as const;
              ...
              <form onSubmit={e => { e.preventDefault(); setSent(true); }} style={{ display: "flex", flexDirection: "column", gap: "1.25rem" }}>
                ...
                <div style={{ display: "flex", flexDirection: "column", gap: "0.4rem" }}>
                  ...
                  <textarea name="message" rows={4}
                    placeholder={type === "speaking" ? "Tell me about the event..." : type === "consulting" ? "Describe what you're building..." : "What's on your mind?"}
                    required
